...
==============
I use this file in the Xed text editor (default text editor for Linux Mint), which it is based on GTKSourceViewer for styles.
...
Installation
------------
Copy *gdscript451.lang* into your */usr/share/gtksourceview-4/language-specs* directory.
                                                            ^ your version might differ, use most recent version you have
